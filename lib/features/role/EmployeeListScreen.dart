...
class EmployeeListScreen extends StatefulWidget {
  ...
  const EmployeeListScreen({Key? key, required this.roleName}) : super(key: key);
...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
    ...
    return Scaffold(
      ...
      body: Consumer<RoleProvider>(
        builder: (context, provider, _) {
          ...
          final users = provider.usersByRole
              .where((user) =>
          ...
          final paginatedUsers = users.sublist(
              startIndex, endIndex < users.length ? endIndex : users.length);
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                tooltip: 'Supprimer',
                                  ...
                                  onPressed: () => _confirmRemoveRole(
                                      context, user.userId, widget.roleName),
                                ),
                                onTap: () {
                                  Clipboard.setData(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: _currentPage * _itemsPerPage < users.length
                          ? () {
                              setState(() {
                                _currentPage++;
                              });
  ...
  Future<void> _confirmRemoveRole(
      BuildContext context, String? userId, String roleName) async {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      final provider = Provider.of<RoleProvider>(context, listen: false);
                      final success = await provider.removeRoleFromUser(userId, roleName);
                      if (success) {
