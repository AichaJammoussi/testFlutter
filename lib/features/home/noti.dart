...
class _noti extends State<noti> {
  int missionsEnCours = 0; // Valeur par défaut, à remplacer par votre logique
  int utilisateursActifs = 0; // Valeur par défaut, à remplacer par votre logique
  int vehiculesDisponibles = 0; // Valeur par défaut, à remplacer par votre logique
